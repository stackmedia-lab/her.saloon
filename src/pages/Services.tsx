        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end mb-24">
          <div className="lg:col-span-8">
            <Reveal>
              ...
              <h1 className="text-[12vw] lg:text-[8vw] font-display font-medium leading-[0.8] uppercase tracking-tighter mb-0">
                Curated <br /> 
                <span className="italic">Specialties.</span>
              </h1>
            </Reveal>
          </div>
          <div className="lg:col-span-4 aspect-square bg-neutral-100 overflow-hidden grayscale hover:grayscale-0 transition-all duration-1000 hidden lg:block">
            <Reveal delay={0.2} width="100%">
              <img 
                src="https://images.unsplash.com/photo-1595476108010-b4d1f231263a?q=80&w=800&auto=format&fit=crop" 
                alt="Styling Detail" 
            ...
            <div key={idx} className="space-y-12">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div className="lg:col-span-4 lg:sticky lg:top-32 h-fit">
                  <Reveal>
                    ...
                    <h2 className="text-4xl font-display font-medium mb-6 uppercase tracking-tight">{category.title}</h2>
                ...
                <div className="lg:col-span-8 flex flex-col gap-px bg-primary/10">
                  {category.services.map((service, sIdx) => (
                    <Reveal key={sIdx} width="100%">
                      <div className="group bg-canvas py-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 hover:bg-neutral-50 transition-colors px-4 md:px-0">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-2">
                            <h3 className="text-xl font-display font-bold uppercase tracking-tight">{service.name}</h3>
              ...
              {idx < 2 && (
                <Reveal width="100%" delay={0.2}>
                   <div className="w-full bg-neutral-100 aspect-video md:aspect-[21/9] grayscale hover:grayscale-0 transition-all duration-1000 overflow-hidden">
                      <img 
                        src={[
                          "https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=2000&auto=format&fit=crop",
                          "https://images.unsplash.com/photo-1620331311719-74c6963955a5?q=80&w=2000&auto=format&fit=crop"
                        ][idx]} 
                        referrerPolicy="no-referrer"
                        className="w-full h-full object-cover" 
